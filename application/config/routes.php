...
$route['blogcategory-list'] = 'Blog/index';
...
$route['retrive-seqblogcat'] = 'Blog/fetch_seqblogcat';
...
$route['fetch-subadminlist']='User/fetch_subadminlist';
...
$route['fetch-rolelist']= 'User/fetch_rolelist';
